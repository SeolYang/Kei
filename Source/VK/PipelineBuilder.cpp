...
namespace sy
{
	namespace vk
	{
		...
		GraphicsPipelineBuilder& GraphicsPipelineBuilder::SetRasterizerSamples(
			VkSampleCountFlagBits rasterizerSamples)
		{
		...
		GraphicsPipelineBuilder& GraphicsPipelineBuilder::SetStencilOpStateFront(
