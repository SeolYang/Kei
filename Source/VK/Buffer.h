...
namespace sy::vk
{
	...
	public:
		...
		auto GetMemoryUsage() const { return this->memoryUsage; }
		[[nodiscard]] auto GetInitialState() const { return this->initialState; }
		[[nodiscard]] auto GetDescriptorInfo(const size_t offset = 0) const { return VkDescriptorBufferInfo{ GetNativeHandle(), offset, GetAlignedSize() }; }
